...
<head>
    ...
    <meta name="Egoli World Business" content="Site em contrução - Developer: David Hadrianus - Inside Linked" />
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <livewire:components.error404-page>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="{{route('home')}}" aria-label="logo image"><img src="{{asset('assets/images/resources/logo-2.png')}}" width="143"
                        alt="" /></a>
            </div>
            <!-- /.logo-box -->
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:needhelp@packageName__.com">contacto@egoli.com</a>
                </li>
                <li>
