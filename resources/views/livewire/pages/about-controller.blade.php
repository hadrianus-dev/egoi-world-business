                ...
                <div class="about-four__right">
                    <div class="section-title text-left">
                        <div class="section-sub-title-box">
                            <p class="section-sub-title">A Nossa Companhinha</p>
                        ...
                        <h2 class="section-title__title">Estrategias globais, soluções locais</h2>
                    </div>
                    ...
                    <div class="about-four__founder">
                       ...
                       <!--  <div class="about-four__founder-content">
                            <h3 class="about-four__founder-name">David Hadrianus</h3>
                            <p class="about-four__founder-sub-title">Founder</p>
                        </div> -->
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-3">
                <div class="brand-one__title">
                    <h2>Nossos pareceiro nessa grande jornada</h2>
                </div>
            </div>
            <div class="col-xl-9">
